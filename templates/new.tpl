{include file="admin__header.tpl" title="Add Promo Code" nav="config"}

      <div>
        <h2 class="page-header">Add Promo Code</h2>
      </div>

      <div>
{include file="_partials/errorsnonsession.tpl"}

      <form action="/admin/promocodes" method="post" class="form-horizontal" role="form" accept-charset="UTF-8">
...
{/foreach}
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button data-disable-with="Processing ..." type="submit" class="btn btn-primary">Add Promo Code</button>
    </div>
  </div>
</form>
    </div>
